...
import {ISupplierFilter, ISupplierList, ISupplierCreation, ISupplierRetunCreation} from "@/types";
import {
    ADD,
    DELETE,
    FILTERLIST,
...
function Supplier() {
    ...
    const [newSupplierReturn, setnewSupplierReturn] = useState<ISupplierRetunCreation>({
        grnId: 0,
        supplierId: 0,
        returnDate: "",
        reason : "",
                        ...
                        <div className="hide-scrollbar relative m-2 max-h-[500px] w-full max-w-md overflow-y-auto rounded-2xl bg-white p-6 text-gray-600 shadow-lg dark:border dark:border-gray-500 dark:bg-gray-800 dark:text-gray-300">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <input
                                    ...
                                    required
                                    className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                    value={newSupplierReturn.supplierId}
                                    onChange={handleChange}
                                />
                                <input
                                    type="text"
                                    ...
                                    required
                                    className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                    value={newSupplierReturn.returnDate}
                                    onChange={handleChange}
                                />
                                <input
                                    type="email"
                                ...
                                <input
                                    ...
                                    minLength={10}
                                    className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                    value={newSupplierReturn.remark}
                                    onChange={handleChange}
                                />
                                <input
                                    type="text"
                                    ...
                                    required
                                    className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                    value={newSupplierReturn.locationId}
                                    onChange={handleChange}
                                />
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                        value={newSupplierReturn.username}
                                        onChange={handleChange}
                                    />
                                </div>
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                        value={newSupplierReturn.items.itemCode}
                                        onChange={handleChange}
                                    />
                                    <input
                                        type="number"
                                        ...
                                        required
                                        className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                        value={newSupplierReturn.items.quantityReturned}
                                        onChange={handleChange}
                                    />
                                    <input
                                        type="number"
                                        ...
                                        required
                                        className="mb-2 w-full rounded-lg border px-3 py-2 focus:outline-none dark:border-gray-500 dark:bg-gray-900"
                                        value={newSupplierReturn.items.unitPrice}
                                        onChange={handleChange}
                                    />
                                </div>
